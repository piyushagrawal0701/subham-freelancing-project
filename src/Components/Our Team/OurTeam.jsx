  ...
  return (
    <>
      <section className="text-gray-600 body-font">
        <div className="container px-5 sm:py-10 py-12 mx-auto">
          <div className="flex flex-col text-center w-full sm:mb-20 mb-14">
            <h1
              className="text-2xl font-bold title-font mb-2 text-gray-900"
              data-aos="zoom-in-up"
              data-aos-delay="50"
            ...
            <p
              className="lg:w-2/3 mx-auto leading-relaxed text-base font-medium"
              data-aos="zoom-in-up"
              data-aos-delay="150"
              data-aos-duration="1000"
            >
            ...
            >
              <div className="h-full flex flex-col items-center text-center">
                ...
                <div className="w-full">
                  ...
                  <h3 className="text-gray-500 mb-3">App Developer</h3>
                  {/* <p className="mb-4">
                    DIY tote bag drinking vinegar cronut adaptogen squid fanny
                    pack vaporware.
                  </p> */}
