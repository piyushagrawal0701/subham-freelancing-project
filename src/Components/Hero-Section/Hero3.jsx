    ...
    <>
      <section class="text-gray-600 body-font">
        <div class="container px-5 sm:py-20 py-12 mx-auto">
          ...
          <div class="container mx-auto flex justify-between sm:px-10 px-5 border-2 border-blue-400 rounded-md py-12 flex-wrap-reverse items-center max-w-6xl bg-blue-100">
