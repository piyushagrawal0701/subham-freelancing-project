...
const Hero2 = () => {
  return (
    <>
      <section className="text-gray-600 body-font border-b-2 border-blue-500 ">
        <div className="container mx-auto flex px-5 sm:py-24 py-12 md:flex-row flex-col items-center max-w-6xl">
